...
默认配置如下，配置详细描述请点击<a href="http://docs.youruncloud.com/#appsoarcatalog/zabbix-server/readme.html" target="_blank">此处</a>。
...
部署完成后，请访问http://IP地址:8082/zabbix。使用详细描述请点击<a href="http://docs.youruncloud.com/#appsoarcatalog/zabbix-server/readme.html" target="_blank">此处</a>。
